...
import { CiHome, CiHashtag, CiBookmark, CiUser } from "react-icons/ci";
    ...
    return (
        <div className="w-full md:w-[20%]">
            <div>
                ...
                <div className={`my-4 fixed bg-white left-0 ${openSideBar ? 'w-64' : 'w-0'} transition-all duration-300 overflow-hidden`}>
